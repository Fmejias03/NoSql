# NoSql
## Nota
 Mi Repositorio: https://github.com/Fmejias03/NoSql.git
...
Para la base de datos NoSQL, utilizaremos MongoDB, que es una base de datos orientada a documentos. MongoDB es open-source y tiene amplia documentación disponible.
...
- Configuración inicial: Inicia configurando MongoDB.

- Modelado de datos: Modela un conjunto de datos para MongoDB. Los datos deben ser lo suficientemente complejos para requerir el uso de programación concurrente (por ejemplo, un número significativo de registros o una estructura de datos compleja).
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify/no-sql
```
