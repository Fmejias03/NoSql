package io.bootify.no_sql.util;

import static io.bootify.no_sql.util.MongoOffsetDateTimeWriter.DATE_FIELD;
import static io.bootify.no_sql.util.MongoOffsetDateTimeWriter.OFFSET_FIELD;
